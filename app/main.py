...
app.include_router(message_router, dependencies=[Depends(get_message_controller)])
app.include_router(conversation_router, dependencies=[Depends(get_conversation_controller)])
